local monster_factory = {
    chances = function(generator)
        monster_chances = {
            orc = 50,
            goblin = generator.from_dungeon_level({{2, 25}, {4, 10}, {6, 0}}),
            kobold = generator.from_dungeon_level({{1, 15}, {3, 30}, {5, 0}}),
            giant_rat = generator.from_dungeon_level({{2, 25}, {4, 15}, {6, 0}}),
            vampire = generator.from_dungeon_level({{9, 1}}),
            troll = generator.from_dungeon_level({{3, 15}, {5, 30}, {7, 60}}),
            ogre = generator.from_dungeon_level({{4, 10}, {6, 20}}),
        }
